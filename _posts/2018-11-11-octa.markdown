...
<p style="text-align: justify; font-family: -apple-system, BlinkMacSystemFont, sans-serif;">OCTA is a tool for test case documents classification, which aims to improve its quality using Machine Learning and NLP</p> **Role:** Creator<br /> **Technologies:** Python - NLP (NLTK) - ML (SVM) - SKLearn - Flask
